        ...
        sources: {
          deepSeek: {
            api: {
              ...
              model: strOr(
                strOr(el.modelNotListed.value, el.model.value),
                defaultApi.model,
              ),
              voice: strOr(
                strOr(el.voiceNotListed.value, el.voice.value),
                defaultApi.voice,
              ),
              responseFormat: strOr(
                el.responseFormat.value,
                defaultApi.responseFormat,
              ),
            },
          },
        },
