...
document.addEventListener("DOMContentLoaded", async () => {
  try {
    [el.audioShortcut, el.ipaShortcut, el.restoreDefaultIpaShortcut].forEach(
      (e) => onlyShorcut(e, false),
    );
  ...
  try {
    ...
    const options = {
      setPronuncationByShortcut: {
        ...
        audioShortcut: strOr(
          el.audioShortcut.value,
          defaultOptions.setPronuncationByShortcut.audioShortcut,
        ),
        ipaShortcut: strOr(
          el.ipaShortcut.value,
          defaultOptions.setPronuncationByShortcut.ipaShortcut,
        ),
        restoreDefaultIpaShortcut: strOr(
          el.restoreDefaultIpaShortcut.value,
          defaultOptions.setPronuncationByShortcut.restoreDefaultIpaShortcut,
        ),
      },
    };
...
async function setFieldsValues() {
  ...
  el.restoreDefaultIpaShortcut.value =
    opt.setPronuncationByShortcut.restoreDefaultIpaShortcut;
}
