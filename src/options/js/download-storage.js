...
el.ipa.addEventListener("click", async () => {
  try {
    ...
    await downloadObject(
      ipaStorage,
      fileName("pronunciation-ipa-storage.json"),
    );
  } catch (error) {
    console.error(error);
  }
...
el.audio.addEventListener("click", async () => {
  try {
    ...
    await downloadObject(
      audioStorage,
      fileName("pronunciation-audio-storage.json"),
    );
  } catch (error) {
    console.error(error);
  }
...
el.audioText.addEventListener("click", async () => {
  try {
    ...
    await downloadObject(
      audioTextStorage,
      fileName("pronunciation-audioText-storage.json"),
    );
  } catch (error) {
    console.error(error);
  }
...
el.options.addEventListener("click", async () => {
  try {
    ...
    await downloadObject(
      optionsStorage,
      fileName("pronunciation-options-storage.json"),
    );
  } catch (error) {
    console.error(error);
  }
...
el.errors.addEventListener("click", async () => {
  try {
    ...
    await downloadObject(
      errorsStorage,
      fileName("pronunciation-errors-storage.json"),
    );
  } catch (error) {
    console.error(error);
  }
