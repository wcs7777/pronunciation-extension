    ...
    const options = {
      audio: {
        text: {
          ...
          skipSeconds: numOr(
            el.skipSeconds.value,
            defaultOptions.audio.text.skipSeconds,
            0,
            300,
          ),
        },
    ...
    const options = {
      audio: {
        text: {
          shortcuts: {
            togglePlayer: strOr(
              el.shortcuts.togglePlayer.value,
              defaultShortcuts.togglePlayer,
            ),
            togglePlay: strOr(
              el.shortcuts.togglePlay.value,
              defaultShortcuts.togglePlay,
            ),
            toggleMute: strOr(
              el.shortcuts.toggleMute.value,
              defaultShortcuts.toggleMute,
            ),
            rewind: strOr(el.shortcuts.rewind.value, defaultShortcuts.rewind),
            previous: strOr(
              el.shortcuts.previous.value,
              defaultShortcuts.previous,
            ),
            next: strOr(el.shortcuts.next.value, defaultShortcuts.next),
            backward: strOr(
              el.shortcuts.backward.value,
              defaultShortcuts.backward,
            ),
            forward: strOr(
              el.shortcuts.forward.value,
              defaultShortcuts.forward,
            ),
            decreaseVolume: strOr(
              el.shortcuts.decreaseVolume.value,
              defaultShortcuts.decreaseVolume,
            ),
            increaseVolume: strOr(
              el.shortcuts.increaseVolume.value,
              defaultShortcuts.increaseVolume,
            ),
            decreaseSpeed: strOr(
              el.shortcuts.decreaseSpeed.value,
              defaultShortcuts.decreaseSpeed,
            ),
            increaseSpeed: strOr(
              el.shortcuts.increaseSpeed.value,
              defaultShortcuts.increaseSpeed,
            ),
            resetSpeed: strOr(
              el.shortcuts.resetSpeed.value,
              defaultShortcuts.resetSpeed,
            ),
          },
        },
      },
