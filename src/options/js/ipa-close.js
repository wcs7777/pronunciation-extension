    ...
    const options = {
      ipa: {
        close: {
          timeout: numOr(
            el.timeout.value,
            defaultOptions.ipa.close.timeout,
            500,
            3600000,
          ),
          ...
          buttonColor: strOr(
            el.buttonColor.value,
            defaultOptions.ipa.close.buttonColor,
          ),
          buttonHoverColor: strOr(
            el.buttonHoverColor.value,
            defaultOptions.ipa.close.buttonHoverColor,
          ),
        },
      },
    };
