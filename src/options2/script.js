...
const el = {
	...
	audio: {
		...
		order: {
			...
			linguee: byId("audioLingueeOrder"),
			lingueeEnabled: byId("audioLingueeEnabled"),
	...
	try {
		...
		const options = {
			audio: {
				...
				linguee: {
					enabled: el.audio.order.lingueeEnabled.checked,
					order: parseInt(el.audio.order.linguee.dataset.order),
				},
				googleSpeech: {
...
async function setFieldsValues() {
	...
	el.audio.order.lingueeEnabled.checked = opt.audio.linguee.enabled;
