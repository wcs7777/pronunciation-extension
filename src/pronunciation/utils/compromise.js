// downloaded from https://unpkg.com/compromise@14.14.4/builds/compromise.js
var e, t;
((e = this),
  (t = function () {
    var e = {
    ...
    class View {
      ...
      clone() {
        ...
        e = e.map((e) =>
          e.map(
            (e) => (((e = Object.assign({}, e)).tags = new Set(e.tags)), e),
          ),
        );
    ...
    var Te = {
      ...
      He = {
        addWords: function (e, t = !1) {
          ...
          (Object.assign(a.one.lexicon, o),
            Object.assign(a.one._multiCache, i));
        },
      },
      Ee = {
      ...
      Gt = function (e) {
        ...
        return null === r || 0 === r || (void 0 !== n.min && r - e.t < n.min)
          ...
          : void 0 !== n.max && r - e.t > n.max
            ? ((e.t = e.t + n.max), !0)
            : (!0 === e.hasGroup && (Et(e, e.t).length = r - e.t),
              (e.t = r),
              !0);
      },
      Ot = function (e, t = 0) {
        ...
        out: function (e) {
          ...
          return "tags" === e
            ? this.docs.map((e) =>
                e.reduce(
                  (e, t) => (
                    (e[t.implicit || t.normal] = Array.from(t.tags)),
                    e
                  ),
                  {},
                ),
        ...
        buildNet: function (e, t) {
          ...
          (e.forEach((e) => {
            ...
            Object.keys(n).forEach((e) => {
              ...
              n[e] = n[e].filter(
                (e) =>
                  "boolean" != typeof t[e.match] && ((t[e.match] = !0), !0),
              );
            }));
            ...
            (!1 !== t.tagger && a.one.bulkTagger(o, r, this.world),
              (o = o.map((e) => {
                let t = e.pointer,
                  ...
                  a = t[2] - t[1];
                return (
                  n.index && (e.pointer = [n.index[0], n.index[1], t[1] + a]),
                  e
                );
              })));
    ...
    const On = / /,
          ...
          (i &&
            ...
            ((e, t, n = "") => {
              ...
              ("string" != typeof t &&
                ...
                console.log(
                  ` ${((a = r), "[33m[3m" + a + "[0m").padEnd(24)} [32m→[0m #${t.padEnd(22)}  ${((e) => "[3m" + e + "[0m")(n)}`,
                ));
            })(e, t, a),
          1 !=
      ...
      qn = function (e) {
        ...
        let n = t[0];
        return (
          n && !n.id && 0 === Object.keys(n.props).length && t.shift(),
          t
        );
      },
    ...
    const Wi = {
      ...
      Ui = function (e, t, n) {
        ...
        ((t[r.PastTense] = t[r.PastTense] || "PastTense"),
          ...
          !0 === n &&
            (t[r.PresentTense] = t[r.PresentTense] || "PresentTense"));
      },
      Ri = function (e, t, n) {
        let r = Ni(e, n);
        t[r] = t[r] || "Superlative";
    ...
    const _i = function (e, t, n, r) {
      ...
      ds = function (e, t, n) {
        ...
        if (0 === r.tags.size) {
          ...
          if (null !== e)
            return (es(r, e, "2-suffix"), (r.confidence = 0.7), !0);
          if (
            r.implicit &&
      ...
      fs = function (e, t, n) {
        ...
        if (0 === r.tags.size) {
          ...
          if (null !== e)
            return (es(r, e, "2-prefix"), (r.confidence = 0.5), !0);
        }
        return null;
      },
      bs = new Set([
      ...
      Ms = function (e, t, n, r) {
        ...
        if (!0 === a[s]) {
          ...
          for (let a = t + 1; a < e.length; a += 1) {
            if ($s(e[a], a, r))
              return (
                o(e.slice(t, a + 1), "Place", n, null, "3-[foo-place]"),
                !0
              );
      ...
      Zs = (e, t = {}, n) => {
        ...
        return (
          a &&
            Us.DEBUG_TAGS &&
            console.log(
              `  [2m[3m      ↓ - '${e.normal || e.implicit}' (#${a})  [0m`,
            ),
          (a = t[a]),
          a
        );
            ...
            toSingular(e) {
              return this.getNth(e).map((e) =>
                (function (e, t) {
                  ...
                  return (
                    e.replace(t.root, o, Eu).tag("Singular", "toPlural"),
                    e
                  );
                })(e, ju(e)),
              );
              ...
              this.getNth(e).forEach((e) => {
                let t = (function (e) {
                  return e.numerator && e.denominator
                    ? `${_u({ num: e.numerator })} out of ${_u({ num: e.denominator })}`
                    : "";
                })(Wu(e));
                e.replaceWith(t);
              }),
    ...
    const Sc = function (e, t) {
      ...
      nh = {
        ...
        "present-progressive": (e) => (
          e.replace("are", "were", eh),
          e.replace("(is|are|am)", "was", eh),
          e
        ),
        "past-progressive": Kc,
        ...
        "modal-past": Kc,
        "want-infinitive": (e) => (
          e.replace("(want|wants)", "wanted", eh),
          e.remove("will"),
          e
        ),
        "gerund-phrase": (e, t) => (
              ...
              return (function (e, t, n) {
                ...
                return r.found
                  ...
                  : !0 === vh(e)
                    ? bh(e)
                    : ((r = e.matchOne(
                        "(will|had|have|has|did|does|do|#Modal)",
                      )),
